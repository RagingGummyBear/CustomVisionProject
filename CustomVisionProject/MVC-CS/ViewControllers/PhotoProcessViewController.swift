...
class PhotoProcessViewController: UIViewController, Storyboarded {
    ...
    weak var coordinator: PhotoProcessCoordinator? // Don't remove
    ...
    func finalUISetup(){
        ...
        self.workingImage = self.selectedImage
        self.mainImageView.image = self.selectedImage
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        autoreleasepool {
            ...
            if let touch = touches.first {
                ...
                self.coordinator?.userTouchBegin(location: touch.location(in: self.mainImageView))
            }
        }
    }
    ...
    func doneDrawing(){
        ...
        self.transitionToProcessingStage()
    }
    
    func transitionToProcessingStage(){
        self.createRect()
    }
